<%-- 
    Document   : tps_total_trips_cost_report
...
<%
    ...
    try
    {
        ...
        columnList = "{ \"data\": \"1\", \"title\": \"Year\", \"orderable\": true },"
                      ...
                      + "{ \"data\": \"5\", \"title\": \"Total Cost Incurred\", \"orderable\": true }";
...
<html>
    <head>
        ...
        <script type="text/javascript">
            ...
            {
                var my_csv = new csvDownload('TpsReportController?type=tps&action=total_trips_cost_csv', 'V3NITY');
                 ...
                 tbl = $("#resultTable").DataTable(
                    {
                        ...
                        paging: true,
                        ajax: {
                            url: 'TpsReportController?type=tps&action=total_trips_cost',
                            data: function(d)
                            {
    ...
    <body>
        <div>
            <h1 class="text-light">Total Trips & Cost Incurred Report</h1>
        </div>
