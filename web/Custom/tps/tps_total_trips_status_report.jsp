    ...
    try
    {
       ...
       columnList = "{ \"data\": \"1\", \"title\": \"Year\", \"orderable\": true },"
                 + "{ \"data\": \"2\", \"title\": \"Month\", \"orderable\": true },"
                      ...
                      + "{ \"data\": \"4\", \"title\": \"Opened Trips\", \"orderable\": true },"
                      + "{ \"data\": \"5\", \"title\": \"Closed Trips\", \"orderable\": true },"
                      + "{ \"data\": \"6\", \"title\": \"Rejected Trips\", \"orderable\": true },"
                      + "{ \"data\": \"7\", \"title\": \"Total Trips\", \"orderable\": true }";
    ...
    <head>
        ...
        <script type="text/javascript">
            ...
            $(document).ready(function()
            {
                ...
                var my_csv = new csvDownload('TpsReportController?type=tps&action=tps_total_trips_and_status_csv', 'V3NITY');
...
//                    $('#driverFilter').val();
                    ...
                    my_csv.startDownload(20000, {customFilterQuery: null, visibleColumnIndexes: null, monthyear: $('#dateTimePicker-mydate').val(), loadingSite: $('#loadingSiteFilter').val()
});
                 ...
                 tbl = $("#resultTable").DataTable(
                    {
                        ...
                        paging: true,
                        ajax: {
                            url: 'TpsReportController?type=tps&action=tps_total_trips_and_status',
                            data: function(d)
                            {
...
//                $('#resultTable').DataTable().search(searchText).draw();
    ...
    <body>
        <div>
            <h1 class="text-light">Total Trips & Status Report</h1>
        </div>
