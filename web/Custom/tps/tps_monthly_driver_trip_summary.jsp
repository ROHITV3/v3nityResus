    ...
    try
    {
        ...
        columnList = "{ \"data\": \"1\", \"title\": \"Year\", \"orderable\": true },"
                 + "{ \"data\": \"2\", \"title\": \"Month\", \"orderable\": true },"
                      + "{ \"data\": \"3\", \"title\": \"Driver\", \"orderable\": true },"
                      + "{ \"data\": \"4\", \"title\": \"Asset\", \"orderable\": true },"
                      + "{ \"data\": \"5\", \"title\": \"Shift\", \"orderable\": true },"
                      + "{ \"data\": \"6\", \"title\": \"Loading Site\", \"orderable\": true },"
                      + "{ \"data\": \"7\", \"title\": \"Unloading Site\", \"orderable\": true },"
                      + "{ \"data\": \"8\", \"title\": \"Total Closed Trip\", \"orderable\": true },"
                      + "{ \"data\": \"9\", \"title\": \"Total Distance(KM)\", \"orderable\": true }";
    ...
    <head>
        ...
        <script type="text/javascript">
            ...
            $(document).ready(function()
            {
                ...
                var my_csv = new csvDownload('TpsReportController?type=tps&action=monthly_driver_trip_csv', 'V3NITY');
...
//              $("#dateTimePicker-mydate2").AnyTime_picker({format: "%m/%Y"});
                ...
                $("#downloadCSV").click(function()
                {
                    ...
                    my_csv.startDownload(20000, {customFilterQuery: null, visibleColumnIndexes: null, monthyear: $('#dateTimePicker-mydate').val(), asset: $('#assetFilter').val(), driver: $('#driverFilter').val() , shift:$('#shiftFilter').val()
});
                 ...
                 tbl = $("#resultTable").DataTable(
                    {
                        ...
                        paging: true,
                        ajax: {
                            url: 'TpsReportController?type=tps&action=monthly_driver_trip',
                            data: function(d)
                            {
...
//                $("#dateTimePicker-mydate2").AnyTime_noPicker();
    ...
    <body>
        <div>
            <h1 class="text-light">TPS Monthly Driver Trip Summary</h1>
        </div>
