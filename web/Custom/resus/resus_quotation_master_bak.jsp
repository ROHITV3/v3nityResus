        ...
        <div id="specific-filter" class="grid filter-menu">
            ...
            <div class="container_quotation_update_status">
                <div id="close_quotation" class="panel" style="width: 200px">
                    ...
                    <div class="content">
                        <button class="button" type="button" title="Close Quotation" onclick="if (confirm('Do you want to close the Quotation?'))
                                    closeQuotation();"><span class="mif-checkmark"></span> Close</button>
                    </div>
                </div>
                ...
                <div id="follow_up_quotation" class="panel" style="width: 200px">
                    ...
                    <div class="content">
                        <button class="button" type="button" title="Follow-Up Quotation" onclick="if (confirm('Do you want to follow up the Quotation?'))
                                    followUpQuotation();"><span class="mif-checkmark"></span> Follow-Up</button>
                    </div>
                </div>
            </div> 
