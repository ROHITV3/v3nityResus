            ...
            $(document).ready(function ()
            {
                ...
                $('select[name=dropdownCustomer]').on('change', function ()
                {
                    ...
                    $.ajax({
                        ...
                        {
                            $('textarea[name=customerName]').val(data.header);
...
//                }
            ...
            function previewQuotationOld() {
                ...
                let customerName = $('textarea[name=customerName]').val();
                let quotationValidityDuration = $('input[name=validity]').val();
                let quotationValidityType = $('select[name=durationType]').val();
                let quotationBillingType = $('select[name=billingType]').val();
            ...
            function previewQuotation()
            {
                    ...
                    let triggerDate = $('input[name=dateTimePicker_trigger_date]').val();
                    let quotationValidityDuration = $('input[name=validity]').val();
                    let quotationValidityType = $('select[name=durationType]').val();
                    let quotationBillingType = $('select[name=billingType]').val();
...
//                        }
                        //Check Duration
                        if (quotationValidityDuration === '0' || quotationValidityDuration === '') {
                            dialog('Failed', 'Please input validity (numeric)', 'alert');
                            return;
                        }
                        //Check Duration Type
...
//                        }
            ...
            function showAdd()
            {
                ...
                $('select[name=quotationType]').val(1);
...
//                                }
            ...
            function resetDialogFieldsAfterHideFromFieldExceptOperator() {
                ...
                document.getElementById("header11").style.display = "";
                document.getElementById("header12").style.display = "";
...
//                        dialog('Error', 'System has encountered an error', 'alert');
                ...
                if (proceedAuthorize) {
                    ...
                    if (columnStatusData.includes('Accepted') || columnStatusData.includes('Client Accepted')||columnStatusData.includes('Accepted (Signoff)')) {
                        $('#button-followup-void').show();
                        $('#followUp-dialog').data('dialog').open();
                    }
...
//                alert("Copied the link " + link);
                ...
                $('textarea[name=followUpEmail]').show();
                $('#followUp-dialog').animate({width: '550px', height: '300px'});
                $('textarea[name=followUpEmail]').val(link);
            }
            ...
            function followUpRecallSubmit()
            {
                ...
                if ($('textarea[name=followUpEmail]').val() === '') {
                        dialog('Failed', 'Please key in remarks to recall the quotation', 'alert');
                        return;
                }
...
//                                console.log(data.descBg);
    ...
    <body>
        ...
        <div data-role="dialog" id="job-customer-send-mail-dialog" data-close-button="false" data-background="bg-white" data-overlay="true" data-overlay-color="op-dark">
        ...
        <div data-role="dialog" id=form-dialog class="medium" data-close-button="false" data-background="bg-white" data-overlay="true" data-overlay-color="op-dark">
                    ...
                    <form id=form-dialog-data method="post" action="list.jsp" autocomplete="off">
                        <div class="grid">
                            ...
                            <div class="grid">
                                ...
                                <div class="row cells1" id="header12">
                                    <div class="cell">
...
<!--                                        <div class="input-control text full-size">
                                    ...
                                    <div class="input-control textarea full-size">                                            
                                        <textarea name="customerName" maxlength="255" rows="3" placeholder="Customer Name"></textarea>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row cells2" id="header11">
                                    <div class="cell">
                                ...
                                <div class="row cells2" id="header8">
                                    <div class="cell">
                                        ...
                                        <span style="color: red; font-weight: bold"> *</span>
                                        <div class="input-control text full-size">
                                            <input type="number" name="validity" maxlength="300" placeholder="Validity" value="" min="0" onkeypress="return (event.charCode !=8 && event.charCode ==0 || (event.charCode >= 48 && event.charCode <= 57));">
                                        </div>
                                    </div>
                                    <div class="cell">
                                ...
                                <div class="row cells2" id="header11">
                                    <div class="cell">
                                        ...
                                        <div class="input-control text" data-role="input" >
                                            <span class="mif-calendar prepend-icon"></span>
                                            <input id="dateTimePicker-trigger-date-id" name="dateTimePicker_trigger_date" class="start" type="text" placeholder="" value="" readonly="" style="padding-right: 36px;">
                                            <button class="button helper-button clear" tabindex="-1" type="button"><span class="mif-cross"></span></button>
                                        </div>
                                    </div>
                                </div>
            ...
            <div class="form-dialog-control">
                <div class="row">     
                    <div class="column">
                        ...
                        <button id="button-add-attachment" class="button" style="float:left; margin-right:10px">Upload Annex (PDF)</button>
        ...
        <div data-role="dialog" id=operator-dialog class="small" data-close-button="false" data-background="bg-white" data-overlay="true" data-overlay-color="op-dark">
            <div class="form-dialog">
                <h1 id=form-dialog-title class="text-light"></h1>
                <div class="form-dialog-content">
                    <form id=form-dialog-data method="post" action="list.jsp" autocomplete="off">
        ...
        <div data-role="dialog" id="followUp-dialog" class="padding20" data-close-button="true" data-width="550" data-height="150" data-overlay="true" data-background="bg-lightOlive" data-color="fg-white">
            ...
            <div class="form-dialog-control">
                <div class="float-left">
                    ...
                    <button id="button-signoff-add-attachment" class="button" style="float:left; margin-right:10px">Signoff Proof (Pdf)</button>
