...
//                                }
            ...
            function closeQuotation()
            {
                ...
                if (columnStatusData.includes('Pending For Authorisation') || columnStatusData.includes('Pending–Client Acceptance')) {
            ...
            function followUpQuotation()
            {
                ...
                if (data.length = 1)
                {
                    ...
                    $('#button-followup-link').data('link', link);
                            ...
                            <div class="grid">
                                ...
                                <div class="row cells2" id="header8">
                                    <div class="cell">
                                        ...
                                        <span style="color: red; font-weight: bold"> *</span>
                                        <div class="input-control text full-size">
                                            <input type="text" name="validity" maxlength="300" placeholder="Validity" value="" onkeydown="return (event.keyCode != 13);">
                                        </div>
                                    </div>
                                    <div class="cell">
