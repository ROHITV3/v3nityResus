...
<%
    ...
    String type = "ResusJobsheetWithoutQuotationMaster";

    ListData data = new ResusJobsheetWithoutQuotationMaster();
                ...
                var tbl = $('#result-table').DataTable(
                        {
                            ...
                            responsive: true,
                            ajax: {
                                url: 'ResusJobsheetWithoutQuotationMasterListController?lib=<%=lib%>&type=<%=type%>&format=json&action=view',
                                type: 'POST',
                                data: function (d)
                                {
