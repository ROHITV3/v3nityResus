...
<html>
    <head>
        ...
        <script>
            ...
            {
                //editJobSheetData
                var jobsheetId = $('#button-save').data('id');
            ...
            function showEdit_Jobsheet(id)
            {
                if (getJobsheetData(id))
                {
                    ...
                    $('#form-dialog-title').html('Edit Jobsheet');
                    $('#button-save').data('action', 'editJobSheetDataWithoutQuotation');
                    $('#button-save').data('id', id);
                    var dialog = $('#ListCustom-form-dialog').data('dialog');
                    dialog.open();
                }
            }
            ...
            function jobsheetShowResultViaPromptBeforeClose() {
                ...
                } else if (action == 'selfSignOff') {
                    let urlLink = $('#button-selfsignoff').data('link');
                    $('#signoff-dialog-content').html('Please copy and send this link to customer : <br>' + urlLink);
                    $('#button-open').show();
                }
                $('#button-no').hide();
            ...
            function selfSignOff() {
                $('#button-yes').data('action', 'selfSignOff');
                $('#signoff-dialog-content').html('Do you want to self-sign off?');
                $('#button-email').hide();
                $('#button-link').hide();
                $('#button-selfsignoff').hide();
                $('#button-nosignoff').hide();
            ...
            function openUrl(){
                let urlLink = $('#button-open').data('link');
    ...
    <body>
        ...
        <div data-role="dialog" id="signoff-dialog" class="padding20" data-close-button="true" data-width="550" data-height="200" data-overlay="true" data-background="bg-lightOlive" data-color="fg-white">
            <h1 id=signoff-dialog-title class="text-light"></h1>
            <p id="signoff-dialog-content"></p>
            <div class="form-dialog-control">
                <button id=button-copy type="button" class="button" onclick="copyUrl()">Copy</button>
                <button id=button-open type="button" class="button" onclick="openUrl()">Open</button>
                ...
                <button id=button-selfsignoff type="button" class="button info" onclick="selfSignOff()">Self Sign Off</button>
        ...
        <div data-role="dialog" id="closeQuotation-dialog" class="padding20" data-close-button="true" data-width="600" data-height="300" data-overlay="true" data-background="bg-lightOlive" data-color="fg-white">
            <h1 id=closeQuotation-dialog-title class="text-light">Close Jobsheet</h1>
            <p id="closeQuotation-dialog-content">Please enter some remarks</p>
            <textarea name="closeRemarks" data-role="textarea" cols="67" rows="8"></textarea>
            <div class="form-dialog-control">
                <button id=button-void-quotation type="button" class="button alert" onclick="closeJobsheet()">Close Jobsheet</button>
                <button id=button-close-quotation type="button" class="button" onclick="cancelEndJobsheet()">Cancel</button>
            </div>
        </div> 
