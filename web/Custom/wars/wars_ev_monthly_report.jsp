...
<html>
    <head>
        ...
        <script>
            ...
            function downloadMonthlyReportOld()
            {
                //window.open("warsReport?type=plan&action=downloadMonthlyReport&workOrderSn=" + $("#dateTimePicker-start-plan_status_date").val(), "_blank", "toolbar=no,status=no,scrollbars=no,menubar=no,height=0,width=0,resizeable=no");
                //window.open("warsReport?type=plan&action=downloadMonthlyReport&workOrderSn=HSA00012EV", "_blank", "toolbar=no,status=no,scrollbars=no,menubar=no,height=0,width=0,resizeable=no");
                window.open("WarsMonthlyReportController?type=plan&action=downloadMonthlyReport&workOrderSn=" + document.getElementById("offender-updated-address").value, "_blank", "toolbar=no,status=no,scrollbars=no,menubar=no,height=0,width=0,resizeable=no");
            }
