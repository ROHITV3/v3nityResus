...
(function ($) {
    ...
    $.fn.AnyTime_clickCurrent = function () {
        this.find('.AnyTime-cur-btn').triggerHandler('click');cl
    }
        ...
        __pickers[id] =
	{
	    ...
	    initialize: function (id) {
	        ...
	        this.inp.focus(this.hFocus =
		    	function (e) {
		    	    //if (_this.lostFocus)      // kevin: this part is affecting the clearing of input text...
		    	    //    _this.showPkr(e);
                    //_this.lostFocus = false;

                    if (_this.lostFocus) _this.lostFocus = true;    // kevin: this statement enables the control to lost focus when click clearing of input text...
		    	});
	    ...
	    pos: function (event) // note: event is ignored but this is a handler
	    {
	        if (this.pop) {
	            ...
	            var top = off.top - this.div.outerHeight(true);
                    /*
                     * REMOVE THE LINE BELOW TO LOCK PICKER TO ALWAYS APPEAR BELOW
                     */
	            if (top < 0)
