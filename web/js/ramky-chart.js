...
var RouteJobStatusChart = function (id, options) {

    var _this = {
        url: 'RamkyChartController',
        type: 'route_job_status',
        ...
        updateChart: function (chart, data) {
            if (data.total === 0) {
                ...
                for (var i = 0; i < data.data.length; i++) {
                    chart.data.labels[i] = data.data[i].label;
                    chart.data.datasets[0].data[i] = data.data[i].total;
                }
            }
        },
        setDetail: function (data) {
            ...
            for (var i = 0; i < data.records.length; i++) {
                ...
                tr.append($('<td/>').html(data.records[i].createdDt));
...
var InternalJobStatusChart = function (id, options) {

    var _this = {
        url: 'RamkyChartController',
        type: 'internal_job_status',
        createChart: function (canvas) {
...
var NEAJobStatusChart = function (id, options) {
