    ...
    <head>
        ...
        <script>
            ...
            <% }%>
                ...
                _live = new v3nityLive('JobMapController', refreshCallback, errorCallback, refreshElapsed);
                    ...
                    if (feature.custom)
                    {
                        switch (event)
                        {
                            case 'ignitionOff':
                                ...
                                imgHTML = '<div class="map-icon-staff-marker-custom small" style="background-image: url(\'../img/' + feature.icons.marker_ignitionoff + '\')"></div>';

                                break;

                            case 'standingTimeLimit':

                                imgHTML = '<div class="map-icon-staff-marker-custom small" style="background-image: url(\'../img/' + feature.icons.marker_standing + '\')"></div>';

                                break;

                            case 'idlingTimeLimit':

                                imgHTML = '<div class="map-icon-staff-marker-custom small" style="background-image: url(\'../img/' + feature.icons.marker_idling + '\')"></div>';
                            ...
                            default:
                                ...
                                if (speed === 0)
                                {
                                    ...
                                    imgHTML = '<div class="map-icon-staff-marker-custom small" style="background-image: url(\'../img/' + feature.icons.marker_stop + '\')"></div>';
                                }
                                else
                                {

                                    imgHTML = '<div class="map-icon-staff-marker-custom small" style="background-image: url(\'../img/' + feature.icons.marker_moving + '\')"></div>';
                                }
                        }
                    }
                    else
                    {
                        switch (event)
                        {
                            case 'ignitionOff':
                                ...
                                imgHTML = '<div class="map-icon-staff-marker small nohover ignitionoff"></div>';

                                break;

                            case 'standingTimeLimit':

                                imgHTML = '<div class="map-icon-staff-marker small nohover standing"></div>';

                                break;

                            case 'idlingTimeLimit':

                                imgHTML = '<div class="map-icon-staff-marker small nohover idling"></div>';

                                break;

                            case 'immobilise':

                                imgHTML = '<div class="map-icon-staff-marker small nohover immobilise"></div>';
                            ...
                            default:
                                ...
                                if (speed === 0)
                                {
                                    ...
                                    imgHTML = '<div class="map-icon-staff-marker small nohover stop"></div>';
                                }
                                else
                                {

                                    imgHTML = '<div class="map-icon-staff-marker small nohover moving"></div>';
                                }
                        }
                    }
            ...
            function refreshCallback(result)
            {
                ...
                for (var i = 0; i < result.data.length; i++)
                {
                    ...
                    if (data.custom)
                    {
                        ...
                        {
                            case 'ignitionOff':
                                markerHTML = '<div class="map-icon-staff-marker-custom small" style="background-image: url(\'img/' + data.icons.marker_ignitionoff + '\')"></div>';
                            ...
                            case 'standingTimeLimit':
                                ...
                                markerHTML = '<div class="map-icon-staff-marker-custom small" style="background-image: url(\'img/' + data.icons.marker_standing + '\')"></div>';
                            ...
                            case 'idlingTimeLimit':
                                markerHTML = '<div class="map-icon-staff-marker-custom small" style="background-image: url(\'img/' + data.icons.marker_idling + '\')"></div>';
                            ...
                            default:
                                if (speed === 0)
                                {
                                    markerHTML = '<div class="map-icon-staff-marker-custom small" style="background-image: url(\'img/' + data.icons.marker_stop + '\')"></div>';

                                    eventName = 'stop';
                                }
                                else
                                {
                                    markerHTML = '<div class="map-icon-staff-marker-custom small" style="background-image: url(\'img/' + data.icons.marker_moving + '\')"></div>';
                    ...
                    else
                    {
                        switch (data.event)
                        {
                            case 'ignitionOff':
                                ...
                                markerHTML = '<div class="map-icon-staff-marker small nohover ignitionoff"></div>';
                            ...
                            case 'standingTimeLimit':
                                ...
                                markerHTML = '<div class="map-icon-staff-marker small nohover standing"></div>';

                                event = eventName = 'standing';

                                break;

                            case 'idlingTimeLimit':

                                markerHTML = '<div class="map-icon-staff-marker small nohover idling"></div>';

                                event = eventName = 'idling';

                                break;

                            case 'immobilise':

                                markerHTML = '<div class="map-icon-staff-marker small nohover immobilise"></div>';

                                event = eventName = "immobilised";
                            ...
                            default:
                                ...
                                if (speed === 0)
                                {
                                    markerHTML = '<div class="map-icon-staff-marker small nohover stop"></div>';

                                    event = eventName = 'stop';
                                }
                                else
                                {
                                    markerHTML = '<div class="map-icon-staff-marker small nohover moving"></div>';

                                    event = eventName = 'moving';
                                }
                        }
                    }
                    ...
                    $('[id^=asset-detail-' + data.id + '-]').each(function()
                    {
                        var details = $(this);
...
//                }
    ...
    <body>
        ...
        <section class="full-screen" style="background-color:black;">
            ...
            %>
            <div class="legend-dialog" style="position: fixed; top: 412px; right: 8px; visibility: hidden">
                <h5 class="text-light"><%=userProperties.getLanguage("legend")%></h5>
                <%
                    if (legendOption.charAt(0) == '1')
                    {
                %>
                <div><div class="map-icon-staff-marker small nohover moving"></div><span class="text-small"> <%=userProperties.getLanguage("moving")%></span></div>
                        <%
                            }
                            ...
                            {
                        %>
                <div><div class="map-icon-staff-marker small nohover stop"></div><span class="text-small"> <%=userProperties.getLanguage("stop")%></span></div>
                        <%
                            }
                            ...
                            {
                        %>
                <div><div class="map-icon-staff-marker small nohover ignitionoff"></div><span class="text-small"> <%=userProperties.getLanguage("ignitionOff")%></span></div>
                        <%
                            }
                            ...
                            {
                        %>
                <div><div class="map-icon-staff-marker small nohover standing"></div><span class="text-small"> <%=userProperties.getLanguage("standing")%></span></div>
                        <%
                            }
                            ...
                            {
                        %>
                <div><div class="map-icon-staff-marker small nohover idling"></div><span class="text-small"> <%=userProperties.getLanguage("idling")%></span></div>
                        <%
                            }
                            ...
                            {
                        %>
                <div><div class="map-icon-staff-marker small nohover immobilise"></div><span class="text-small"> <%=userProperties.getLanguage("immobilised")%></span></div>
                        <%
                            }
                        %>
                        <%
            ...
            %>
             <div class="legend-dialog" style="position: fixed; top: 600px; right: 8px; visibility: hidden">
                <h5 class="text-light"><%=userProperties.getLanguage("legend")%></h5>
