...
<%
    ...
    String lib = "v3nity.cust.biz.controller";

    String type = "OSTJobSchedule";

    ListData data = new OSTJobSchedule();
                ...
                var tbl = $('#result-table').DataTable(
                    {
                        ...
                        responsive: true,
                        ajax: {
                            url: 'OSTListController?lib=<%=lib%>&type=<%=type%>&format=json&action=view',
                            type: 'POST',
                            data: function(d)
                            {
...
//                }
            ...
            function downloadPDF(id)
            {
                ...
                var pdfdialog = window.open("OSTJobScheduleController?type=plan&action=pdf&id=" + id + "&geotagCheck=" + geotagCheck, "_blank", "toolbar=no,status=no,scrollbars=no,menubar=no,height=" + screen.height + ",width=" + screen.width + ",resizeable=no");
...
//                    console.log('data: ' + $('#form-dialog-data').serialize());
            ...
            function showEdit_OSTJobSchedule(id)
            {
...
//                            }
    ...
    <body>
        <div>
            <h1 class="text-light"><%=userProperties.getLanguage("OSTjobschedule")%></h1>
        </div>
        <div class="toolbar">
            <%
