    ...
    <head>
        ...
        <script type="text/javascript">
            ...
            function createTable()
            {
                ...
                $("#tableView").html("<table id=\"table-settings\" data-orientation=\"\" data-margins=\"\" style=\"border-collapse: separate; border-spacing: 0;\"></table>");
            ...
            function mergeCells()
            {
                ...
                else if ($("#tableView table .selected").eq(0).attr("id") === $("#tableView table .selected").eq(1).attr("id"))
                {
                    ...
                    if ($("#tableView table .selected").eq(0).parent().index() === $("#tableView table .selected").eq(1).parent().index() - mergeRow)
                    {
                        ...
                        {
                            //code to merge row
                            if ($("#tableView table .selected").eq(0).attr("colspan") === $("#tableView table .selected").eq(1).attr("colspan"))
                            { //selected cells are same height
...
//                            var x = row.insertCell(1);
            ...
            function createDynamicFieldDropDown()
            {
                ...
                html1 += "<option data-dropdown ='system' data-role='Driver' data-name='Driver' value='2'>Staff</option>";
                ...
                html1 += "<option data-dropdown ='system' data-role='Schedule Date Time' data-name='Schedule Date Time' value='6'>Schedule Date Time</option>";
                html1 += "<option data-dropdown ='system' data-role='Location' data-name='Location' value='7'>Location</option>";
                ...
                html1 += "<option data-dropdown ='system' data-role='Actual Start Date Time' data-name='Actual Start Date Time' value='8'>Actual Start Date Time</option>";
                html1 += "<option data-dropdown ='system' data-role='Actual End Date Time' data-name='Actual End Date Time' value='9'>Actual End Date Time</option>";
                html1 += "<option data-dropdown ='system' data-role='Actual Start Date' data-name='Actual Start Date' value='10'>Actual Start Date</option>";
                html1 += "<option data-dropdown ='system' data-role='Actual End Date' data-name='Actual End Date' value=11>Actual End Date</option>";
                html1 += "<option data-dropdown ='system' data-role='Ratings Sub Total' data-name='Ratings Sub Total' value='12'>Ratings Sub Total</option>";
                html1 += "<option data-dropdown ='system' data-role='Ratings Grand Total' data-name='Ratings Grand Total' value='13'>Ratings Grand Total</option>";
                html1 += "<option data-dropdown ='system' data-role='Description' data-name='Description' value='14'>Description</option>";
                html1 += "<option data-dropdown ='system' data-role='Page Break' data-name='Page Break' value='15'>Page Break</option>";
                html1 += "<option data-dropdown ='system' data-role='Job Customer Name' data-name='Job Customer Name' value='16'>Job Customer Name</option>";
