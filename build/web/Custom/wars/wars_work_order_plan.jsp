        ...
        <script>
            ...
            $(document).ready(function ()
            {
                ...
                /*
                 ...
                 {display: 'Executed', value: '2'},
                 {display: 'Withheld', value: '3'},
                 {display: 'Cancel', value: '4'},
                 {display: 'Abort', value: '5'}
                 ]
                 },
                 {
                 'column': 8,
                 'type': 'list-confirm',
                 'options': [
                 {display: 'Residence', value: '1'},
                 {display: 'Workplace', value: '2'}
                 ]
                 },
                 {
                 'column': 7,
            ...
            //Not In Use
            /*
             function cellUpdate(cell, row, oldValue)
             {
             ...
             data:
             {
             'workOrderPlanId': row.id(),
             'warrantStatusId': cell.data()
             },
             ...
             $.ajax({
             type: 'POST',
             url: 'wars?type=plan&action=updateAddressType',
             data:
             {
             'workOrderPlanId': row.id(),
             'addressTypeId': cell.data()
             },
             success: function (data)
             {
             if (data.expired === undefined)
