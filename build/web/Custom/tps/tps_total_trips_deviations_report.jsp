    ...
    try
    {
       ...
       columnList = "{ \"data\": \"1\", \"title\": \"Year\", \"orderable\": true },"
                 + "{ \"data\": \"2\", \"title\": \"Month\", \"orderable\": true },"
                      ...
                      + "{ \"data\": \"6\", \"title\": \"Total Deviations\", \"orderable\": true }";
    ...
    <head>
        ...
        <script type="text/javascript">
            ...
            $(document).ready(function()
            {
                ...
                var my_csv = new csvDownload('TpsReportController?type=tps&action=tps_total_trips_deviations_csv', 'V3NITY');
                 ...
                 tbl = $("#resultTable").DataTable(
                    {
                        ...
                        paging: true,
                        ajax: {
                            url: 'TpsReportController?type=tps&action=tps_total_trips_deviations',
                            data: function(d)
                            {
...
//                $('#resultTable').DataTable().search(searchText).draw();
    ...
    <body>
        <div>
            <h1 class="text-light">Total Trips & Deviations Report</h1>
        </div>
