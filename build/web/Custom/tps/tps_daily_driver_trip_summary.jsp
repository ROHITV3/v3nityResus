...
<%
    ...
    try
    {
        ...
        columnList = "{ \"data\": \"1\", \"title\": \"Entry Date\", \"orderable\": true },"
                      + "{ \"data\": \"2\", \"title\": \"Driver\", \"orderable\": true },"
                      + "{ \"data\": \"3\", \"title\": \"Asset\", \"orderable\": true },"
                      + "{ \"data\": \"4\", \"title\": \"Shift\", \"orderable\": true },"
                      + "{ \"data\": \"5\", \"title\": \"Loading Site\", \"orderable\": true },"
                      + "{ \"data\": \"6\", \"title\": \"Unloading Site\", \"orderable\": true },"
                      + "{ \"data\": \"7\", \"title\": \"Total Closed Trip\", \"orderable\": true },"
                      + "{ \"data\": \"8\", \"title\": \"Total Distance(KM)\", \"orderable\": true }";
...
<html>
    <head>
        ...
        <script type="text/javascript">
            ...
            {
                var my_csv = new csvDownload('TpsReportController?type=tps&action=daily_driver_trip_csv', 'V3NITY');
              ...
              $("#dateTimePicker-mydate").AnyTime_picker({format: "%d/%m/%Y"});
              $("#dateTimePicker-mydate2").AnyTime_picker({format: "%d/%m/%Y"});
                ...
                $("#downloadCSV").click(function()
                {
                    ...
                    var fromDate = $('#dateTimePicker-mydate').val();
                    var toDate = $('#dateTimePicker-mydate2').val();
                    var driver = $('#driverFilter').val();
                    var asset = $('#assetFilter').val();
                    var shift = $('#shiftFilter').val();
                    
                    my_csv.startDownload(20000, {customFilterQuery: null, visibleColumnIndexes: null,fromDate: fromDate,toDate: toDate, driver: driver,asset: asset,shift: shift});
                 ...
                 tbl = $("#resultTable").DataTable(
                    {
                        ...
                        paging: true,
                        ajax: {
                            url: 'TpsReportController?type=tps&action=daily_driver_trip',
                            data: function(d)
                            {
                               // d.driverId1 = $("#driverId1").val();
                               // d.driverId2 = $("#driverId2").val();
                               d.fromDate = $('#dateTimePicker-mydate').val();
            ...
            function searchData2()
            {
                ...
                var driverName = $('#driverFilter').val();
                
                var assetName = $('#assetFilter').val();
                
                var shiftName = $('#shiftFilter').val();
                
                
                if($('#dateTimePicker-mydate').val() !== "" || $('#dateTimePicker-mydate2').val() !=="")
                {
                tbl.clear().destroy();
                ...
                {
                    dialog('Failed','Please select Entry Date Filter','alert');
                }
    ...
    <body>
        <div>
            <h1 class="text-light">TPS Daily Driver Trip Summary</h1>
        </div>
        ...
        <div class="grid">
            ...
            <div class="cell" style="width:250px;display:inline-table;" >
                <h4 class="text-light">Entry Date<span style="color: red; font-weight: bold"> *</span></h4>
                ...
                <div class="cell" style="width:250px;display:inline-table;" >
                    <h4 class="text-light">Driver</h4>
                    <div class="input-control text" data-role="input">
                        <%
                            out.write("<div class=\"input-control text\" style=\"width: 200px;\">");
                            out.write("<select name = \" Select Driver\" id=\"driverFilter\">");
                            out.write("</select>");
                            out.write("</div>");
//                            out.write("</div>");
                ...
                <div class="cell" style="width:250px;display:inline-table;" >
                    <h4 class="text-light">Asset</h4>
                    <div class="input-control text" data-role="input">
                        <%
                            out.write("<div class=\"input-control text\" style=\"width: 200px;\">");
                            out.write("<select name = \" Select Asset\" id=\"assetFilter\">");
                            out.write("</select>");
                            out.write("</div>");
//                            out.write("</div>");
                   ...
                   <div class="cell" style="width:250px;display:inline-table;" >
                    <h4 class="text-light">Shift</h4>
                    <div class="input-control text" data-role="input">
                        <%
                            out.write("<div class=\"input-control text\" style=\"width: 200px;\">");
                            out.write("<select name = \" Select Shift\" id=\"shiftFilter\">");
                            out.write("</select>");
                            out.write("</div>");
//                            out.write("</div>");
