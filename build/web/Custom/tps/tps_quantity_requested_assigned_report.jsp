<%-- 
    Document   : tps_quantity_requested_assigned_report
...
<%
    ...
    try
    {
        ...
        columnList = "{ \"data\": \"1\", \"title\": \"Year\", \"orderable\": true },"
                      ...
                      + "{ \"data\": \"4\", \"title\": \"Requested Quantity\", \"orderable\": true },"
                      + "{ \"data\": \"5\", \"title\": \"Assigned Quantity\", \"orderable\": true },"
                      + "{ \"data\": \"6\", \"title\": \"Variant\", \"orderable\": true }";
...
<html>
    <head>
        ...
        <script type="text/javascript">
            ...
            {
                var my_csv = new csvDownload('TpsReportController?type=tps&action=tps_monthly_request_assign_csv', 'V3NITY');
                 ...
                 tbl = $("#resultTable").DataTable(
                    {
                        ...
                        paging: true,
                        ajax: {
                            url: 'TpsReportController?type=tps&action=tps_monthly_request_assign',
                            data: function(d)
                            {
    ...
    <body>
        <div>
            <h1 class="text-light">Monthly Quantity Requested vs Assigned Report</h1>
        </div>
