...
<%
    ...
    String type = "ResusQuotationMaster";

    ListData data = new ResusQuotationMaster();
...
//                                }
            ...
            function closeQuotation()
            {
                ...
                if (data.length > 0)
                {
                    ...
                    $.ajax({
                        type: 'POST',
                        url: 'ResusQuotationController?type=plan&action=closeQuotation',
                        data:
                                {
                                    'quotationId': id
                                },
...
//
//                var testColIndex = table.column(':contains(Status)');
//
//                console.log('testcoldata : ' + testColIndex[0]);
//
//                var columnData = table.cell(dataIndex[0], testColIndex[0]).data()
//
//                console.log('column data : ' + columnData);
//
//                if (columnData.includes('Pending For Authorisation')) {
//                    console.log('Pending For Authorisation - Send Email To BD');
//                } else if (columnData.includes('Pending–Client Acceptance')) {
//                    console.log('Pending–Client Acceptance - Send Email/Create Link For Client');
//                } else {
//                    console.log('No Follow Up Needed');
//                }
                
                $('textarea[name=followUpEmail]').val('Test@email.com');
...
//                    $.ajax({
//                        type: 'POST',
//                        url: 'ResusQuotationController?type=plan&action=followUpQuotation',
//                        data:
//                                {
//                                    'quotationId': id
//                                },
...
//                }
            ...
            function closeQuotation2()
            {
                ...
                } else if (columnStatusData.includes('Accepted')) {
                    console.log('Terminate Quotation');
                    $('#closeQuotation-dialog-title').html('Terminate - ' + columnRefNoData);
                    $('#button-terminate-quotation').show();
                } else {
                    console.log('Void the quotation');
                    $('#closeQuotation-dialog-title').html('Close - ' + columnRefNoData);
...
//                    });
    ...
    <body>
        ...
        <div id="specific-filter" class="grid filter-menu">
            ...
            <div class="container_quotation_update_status">
                <div id="close_quotation" class="panel" style="width: 200px">
                    ...
                    <div class="content">
                        <button class="button" type="button" title="Close Quotation" onclick="closeQuotation2();"><span class="mif-checkmark"></span> Close</button>
                    </div>
                </div>
                <!--                <div id="reject_quotation" class="panel" style="width: 200px">
                                    <div class="heading">
                                        <span class="title">Reject Quotation</span>
                                    </div>
                                    <div class="content">
                                        <button class="button" type="button" title="Reject Quotation" onclick="if (confirm('Do you want to reject the Quotation?'))
                                                    rejectQuotation();"><span class="mif-checkmark"></span> Reject</button>
                                    </div>
                                </div>-->
        ...
        <div data-role="dialog" id="closeQuotation-dialog" class="padding20" data-close-button="true" data-width="550" data-height="300" data-overlay="true" data-background="bg-lightOlive" data-color="fg-white">
            ...
            <textarea data-role="textarea" cols="70" rows="8"></textarea>
            <div class="form-dialog-control">
                <button id=button-void-quotation type="button" class="button alert" onclick="selectNoSignoff()">Void Quotation</button>
                <button id=button-terminate-quotation type="button" class="button alert" onclick="signOffEmail()">Terminate Quotation</button>
                <button id=button-reject-quotation type="button" class="button alert" onclick="signOffLink()">Reject Quotation</button>
        ...
        <div data-role="dialog" id="followUp-dialog" class="padding20" data-close-button="true" data-width="550" data-height="150" data-overlay="true" data-background="bg-lightOlive" data-color="fg-white">
            <h1 id=closeQuotation-dialog-title class="text-light">Follow-Up RCS/23/MAR/0006</h1>
            ...
            <div class="form-dialog-control">
                ...
                <button id=button-followup-cancel type="button" class="button" onclick="cancle()">Cancel</button>
            </div>
        </div>  
    </body>
</html>
