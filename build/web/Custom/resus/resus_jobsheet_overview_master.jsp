...
<%
    ...
    String type = "ResusJobsheetOverviewMaster";

    ListData data = new ResusJobsheetOverviewMaster();
                ...
                var tbl = $('#result-table').DataTable(
                        {
                            ...
                            responsive: true,
                            ajax: {
                                url: 'ResusJobsheetOverviewMasterListController?lib=<%=lib%>&type=<%=type%>&format=json&action=view',
                                type: 'POST',
                                data: function (d)
                                {
