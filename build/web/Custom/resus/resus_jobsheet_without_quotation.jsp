...
<%
    ...
    String type = "ResusJobsheetWithoutQuotation";

    ListData data = new ResusJobsheetWithoutQuotation();
    ...
    ResusCostCentreDropDown resusCostCentreDropDown = new ResusCostCentreDropDown(userProperties);
    resusCostCentreDropDown.setIdentifier("dropdown-cost-centre-customer");
    resusCostCentreDropDown.loadData(userProperties);
                ...
                var tbl = $('#result-table').DataTable(
                        {
                            ...
                            responsive: true,
                            ajax: {
                                url: 'ResusJobsheetWithoutQuotationListController?lib=<%=lib%>&type=<%=type%>&format=json&action=view',
                                type: 'POST',
                                data: function (d)
                                {
...
//                }
            ...
            function saveJobsheetForm()
            {
                ...
                if (action === 'addJobSheetDataWithoutQuotation' || action === 'editJobSheetDataWithoutQuotation'){
...
//                        }
            ...
            //To copy Job Sheet tied to the quotation
            function copyJobSheet(jobsheetId)
            {
                clearJobsheetDataInDialog();
                //get jobsheet data
                $.ajax({
