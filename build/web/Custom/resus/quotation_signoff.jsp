...
//                        dialog('Error', 'System has encountered an error', 'alert');
            ...
            function getQuotationPdf()
            {
                ...
                $.ajax({
                    type: 'POST',
                    url: 'ResusQuotationCustomerSignoffController',
                    data: {
                        action: 'getQuotation',
                        id: '<%=quotationId%>',
                        customerId: '1'
...
//                        dialog('Error', 'System has encountered an error', 'alert');
            ...
            function embedSignature(image)
            {
                ...
                if ($('input[name=custName]').val().trim().length === 0) {
                ...
                let confirmAction = confirm("Are you sure to accept this quotation?");
                if (confirmAction) {
                    $.ajax({
                        type: 'POST',
                        url: 'ResusQuotationCustomerSignoffController',
...
//                        dialog('Error', 'System has encountered an error', 'alert');
            ...
            function initCanvas()
            {
                ...
                newFieldHeader.textContent = "Agreed on behalf of";
...
//                newFieldHeader.setAttribute('placeholder', 'Name');
                ...
                newField2.setAttribute('size', 30);
                ...
                saveSignature.innerHTML = 'Accept';
