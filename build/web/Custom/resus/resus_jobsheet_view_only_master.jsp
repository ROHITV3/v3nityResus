...
<%
    ...
    String type = "ResusJobsheetViewOnlyMaster";

    ListData data = new ResusJobsheetViewOnlyMaster();
                ...
                var tbl = $('#result-table').DataTable(
                        {
                            ...
                            responsive: true,
                            ajax: {
                                url: 'ResusJobsheetViewOnlyMasterListController?lib=<%=lib%>&type=<%=type%>&format=json&action=view',
                                type: 'POST',
                                data: function (d)
                                {
